...
<!-- | ℹ️ **More information** | See also [ECIS2024 app page for this workshop](https://connect-v3.jujama.com/Agenda/SessionDetails?id=351891){: target="_blank"} (requires login) | -->
